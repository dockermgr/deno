...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210122040-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Oct 12, 2022 20:40 EDT
# @@File             :  install.sh
# @@Description      :
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/deno"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="deno"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/deno"
APPDIR="$HOME/.local/share/srv/docker/deno"
DATADIR="$HOME/.local/share/srv/docker/deno/files"
...
CONTAINER_HTTP_PORT="19050:4000"
